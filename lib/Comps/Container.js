...
var Container = function (_React$Component) {
    ...
    function Container(props) {
        ...
        _this.updateTree(props.value, props.schema);
    ...
    _createClass(Container, [{
        ...
        key: 'updateTree',
        value: function updateTree(value, schema) {
            var _this2 = this;
            ...
            this.tree.commit();
            this.tree.select('value').on('update', function (event) {
                return _this2.props.onChange(event.data.currentData);
            });
        }
    }, {
        key: 'validate',
